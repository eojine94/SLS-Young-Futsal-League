...
export function DeleteConfirmDialog({ open, onClose, onConfirm }: DeleteConfirmDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      {/* Dialog Card */}
      <div className="relative flex w-80 flex-col items-center gap-6 rounded-[20px] bg-white p-6">
        {/* Warning Icon */}
        ...
        <div className="flex w-full gap-3">
          <button
            onClick={onClose}
            className="flex h-11 flex-1 cursor-pointer items-center justify-center rounded-lg border-[1.5px] border-border bg-white text-sm font-semibold text-foreground"
          >
            취소
          </button>
          <button
